...
const AdminReviews: React.FC = () => {
  ...
  const fetchReviews = async () => {
    ...
    try {
      ...
      const res = await axios.get(
        'https://project-ma-nguon-mo-3.onrender.com/api/api/reviews/admin/all',
        {
  ...
  const fetchStatistics = async () => {
    ...
    try {
      const res = await axios.get(
        'https://project-ma-nguon-mo-3.onrender.com/api/api/reviews/admin/statistics',
        {
          headers: { Authorization: `Bearer ${token}` }
        }
      );
  ...
  const handleToggleVisibility = async (reviewId: string, currentStatus: boolean) => {
    ...
    try {
      await axios.put(
        `https://project-ma-nguon-mo-3.onrender.com/api/api/reviews/admin/${reviewId}/visibility`,
  ...
  const handleDelete = async (reviewId: string) => {
    ...
    try {
      await axios.delete(
        `https://project-ma-nguon-mo-3.onrender.com/api/api/reviews/admin/${reviewId}`,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
      );
