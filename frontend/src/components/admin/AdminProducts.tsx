...
const AdminProducts: React.FC = () => {
  ...
  const API_URL = 'https://project-ma-nguon-mo-3.onrender.com/api/api/products';
  const CATEGORIES_URL = 'https://project-ma-nguon-mo-3.onrender.com/api/api/categories';
